...
const OrderForm = () => {
    ...
    const calculateTotal = () => {
        return cart.length > 0 
            ? cart[0].items.reduce((total, item) => total + item.product.price * item.unit, 0).toFixed(2)
            : '0.00';
    };
                                ...
                                >
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="flex items-center space-x-4 mt-2">
                                            ...
                                            <div className="flex items-center bg-white/10 rounded-full">
                                                <button className="p-2 hover:bg-white/20 rounded-l-full">
                                                    <MinusIcon className="w-4 h-4 text-white" />
                                                </button>
                                                <span className="px-3 text-white">{item.unit}</span>
                                                <button className="p-2 hover:bg-white/20 rounded-r-full">
                                    ...
                                    <div className="flex flex-col items-end">
                                        <span className="text-xl font-bold text-green-300">
                                            ${(item.product.price * item.unit).toFixed(2)}
                                        </span>
